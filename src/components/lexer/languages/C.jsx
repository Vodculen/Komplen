...
export function lexIdentifier(lexer) {
	...
	} else if ((helpers.back(lexer, -2)?.value === "struct" || helpers.back(lexer, -2)?.value === "}") || (helpers.back(lexer, -2)?.value === "enum" || helpers.back(lexer, -2)?.value === "}") || (helpers.back(lexer, -2)?.value === "union" || helpers.back(lexer, -2)?.value === "}")) {
